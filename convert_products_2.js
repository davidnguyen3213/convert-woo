function testConvertSpf() {
  ...
  if(confirm == SpreadsheetApp.getUi().Button.NO) return;
    ...
    wpsheet.getRange(2, 1, wpsheet.getDataRange().getNumRows()-1, 40).clear();
  ...
  //0->29
  var cate = checkExitsString(spfdata[flag][0], spfdata[flag][3]);
  var data_first = ['variable',spfdata[flag][4],spfdata[flag][0],spfdata[flag][1],1,"visible",spfdata[flag][2],"taxable","",1,10,1,1,"","",cate,spfdata[flag][5],spfdata[flag][24],"",position,spfdata[flag][7],"",1,0,spfdata[flag][8],spfdata[flag][9],"",1,1,spfdata[flag][10],spfdata[flag][11],"",1,1,spfdata[flag][12]];
  for(k=1;k< spfdata.length;k++){
    ...
    if(data_first[2] == spfdata[k][0] ){
      ...
      array_attribue_3.push(spfdata[k][12]);
      if(spfdata[k][43] != ""){
        data_push = ['variation',spfdata[k][13],spfdata[flag][0],spfdata[flag][1],1,"visible","","taxable","parent",1,"",0,0,spfdata[k][19],spfdata[k][20],"","",spfdata[k][43],spfdata[flag][4],position,spfdata[flag][7],spfdata[k][8],"",0,"",spfdata[flag][9],spfdata[k][10],"",1,"",spfdata[flag][11],spfdata[k][12],"",1,""];
        ...
        if( k == Number(spfdata.length)- 1){
          ...
          data_first[31] = getAttribute(array_attribue_3);
      ...
      data = [];
      data_flag = [];
      cate = checkExitsString(spfdata[flag][0], spfdata[flag][3]);
      data_first = ['variable',spfdata[flag][4],spfdata[flag][0],spfdata[flag][1],1,"visible",spfdata[flag][2],"taxable","",1,10,1,1,"","",cate,spfdata[flag][5],spfdata[flag][24],"",position,spfdata[flag][7],"",1,0,spfdata[flag][8],spfdata[flag][9],"",1,1,spfdata[flag][10],spfdata[flag][11],"",1,1,spfdata[flag][12]];
      data_push = ['variation',spfdata[k][13],spfdata[flag][0],spfdata[flag][1],1,"visible","","taxable","parent",1,"",0,0,spfdata[k][19],spfdata[k][20],"","",spfdata[k][43],spfdata[flag][4],++position,spfdata[flag][7],spfdata[k][8],"",0,"",spfdata[flag][9],spfdata[k][10],"",1,"",spfdata[flag][11],spfdata[k][12],"",1,""];
      data_flag.push(data_push);
      array_attribue_1.push(spfdata[k][8]);
      array_attribue_2.push(spfdata[k][10]);
...
function checkExitsString(handle, cate){
  
  if(handle.indexOf("custom-name") != -1){
    cate = cate + ",Custom Name";
  }
